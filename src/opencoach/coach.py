...
async def make_coach() -> CompiledGraph:
    """Create a coaching agent using the GROW model."""
    ...
    coach_agent: CompiledGraph = create_react_agent(
        model=llm,
        tools=[get_time],
